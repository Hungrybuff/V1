...
class _CompletedOrdersTabState extends State<CompletedOrdersTab> {
  ...
  Widget build(BuildContext context) {
    return FutureBuilder<Stream<QuerySnapshot>>(
        future: bloc.getCompletedOrdersStream(),
          ...
          return StreamBuilder<QuerySnapshot>(
              ...
              builder: (context, snapshot) {
                ...
                if (snapshot.data.documents.length == 0) {
                  return Center(child: new Text("Nothing to show."));
                }
              ...
              showDialog<void>(
                ...
                builder: (BuildContext dialogContext) {
                  return AlertDialog(
                    ...
                    content: Text('Confirm to deliver the order to user'),
                    actions: <Widget>[
                      FlatButton(
                        child: Text('Cancel'),
                        onPressed: () {
                      ...
                      FlatButton(
                        ...
                        onPressed: () async {
                          await bloc.markOrderAsPicked(order);
                          Navigator.of(dialogContext)
                              .pop(); // Dismiss alert dialog
                        },
                      ),
  ...
  Widget buildPriceWidget(FoodItem model) {
    return Padding(
      padding: const EdgeInsets.only(top: 8.0),
      child: Text(
          NumberFormat.currency().format(model.price),
        style: TextStyle(
